...
let board = new Board("10w5h1 0 2 0 2 1 2 2 3 0 3 2 4 0 5 0 5 2 6 0 6 1 6 2p1 1 2 3 3 1 4 1 4 2 5 1t0 0 7 2s3 3e", document.querySelector("canvas"), 240, document.querySelector("#moneyCount"), document.querySelector("#hpCount"))
